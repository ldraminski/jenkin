jQuery.fn.gsliderV2 = function(options) {
    var defaults = {           
        slider: $(this),
        holder: null,
        prev: null,
    ...
    return this.each(function() {
            ...
            function createPages(countItems,$item) {
                ...
                for (var i = 0; i < countItems; i++) {
                    ...
                    var dataDot = $item.eq(i).attr('data-dot');
                    if(dataDot==null || dataDot=='' || dataDot=='undefined'){
                        var dotTxt = ""; 
                    } else {
                        var dotTxt = "<span>"+dataDot+"</span>";
                    }
                    var dot = jQuery("<li class='" + classes + "' >"+dotTxt+"</li>");
            ...
            gazeta_pl.renSwipe.init({
                $element: $slider,
                functionExecuteSwipeRight: slideRight,
                functionExecuteSwipeLeft: slideLeft
            });
...
// example of use
//$('.mod_uzr4.single').gsliderV2({holder: '.body > div', prev: '.prev', next: '.next', visibleElemes: '1', pagination: true, loop: '1'});   